...
<title>${message("admin.freightConfig.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="freightConfig.first_price" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="freightConfig.continue_price" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>

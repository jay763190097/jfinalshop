...
<title>${message("admin.refunds.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.refunds.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "sn"] class="current"[/#if] val="sn">${message("Refunds.sn")}</li>
					<li[#if pageable.searchProperty == "account"] class="current"[/#if] val="account">${message("Refunds.account")}</li>
					<li[#if pageable.searchProperty == "payee"] class="current"[/#if] val="payee">${message("Refunds.payee")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="payment_method">${message("Refunds.paymentMethod")}</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="orders">${message("Refunds.order")}</a>
				</th>
				<th>

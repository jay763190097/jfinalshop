	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="article.seo_title" class="text" value="${article.seo_title}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_keywords" class="text" value="${article.seo_keywords}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_description" class="text" value="${article.seo_description}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>

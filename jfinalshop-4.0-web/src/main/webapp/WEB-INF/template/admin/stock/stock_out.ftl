...
<title>${message("admin.stock.stockOut")} - Powered By JFinalShop</title>
...
$().ready(function() {
	...
	// 商品选择
	$productSelect.autocomplete("productSelect.jhtml", {
		dataType: "json",
		max: 20,
		width: 218,
		scrollHeight: 300,
...
<body>
	...
	<form id="inputForm" action="stockOutSubmit.jhtml" method="post">

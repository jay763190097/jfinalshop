...
<title>${message("admin.plugin.weixinPayment.setting")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.plugin.weixinPayment.setting")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinPayment.partner")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinPayment.key")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinPayment.paternerKey")}:
				</th>
				<td>
					<input type="text" name="paternerKey" class="text" value="${pluginConfig.getAttribute("paternerKey")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinPayment.appSecret")}:
				</th>
				<td>

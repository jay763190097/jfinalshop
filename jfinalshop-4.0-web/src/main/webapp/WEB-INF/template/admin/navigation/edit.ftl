...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("Navigation.channel")}:
                </th>
                <td>
                    <input type="text" id="channel"  name="Navigation.channel" class="text Wdate"/>
                </td>
            </tr>
			<tr>
				<th>

...
<title>${message("admin.promotion.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input tabContent">
			<tr>
				...
				<td>
					<input type="text" name="promotion.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="promotion.title" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="promotion.image" class="text" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" id="beginDate" name="promotion.begin_date" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss', maxDate: '#F{$dp.$D(\'endDate\')}'});" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="endDate" name="promotion.end_date" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss', minDate: '#F{$dp.$D(\'beginDate\')}'});" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="minimumPrice" name="promotion.minimum_price" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name=""promotion.maximum_price" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="minimumQuantity" name="promotion.minimum_quantity" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="promotion.maximum_quantity" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="promotion.price_expression" class="text" maxlength="255" title="${message("admin.promotion.priceExpressionTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="promotion.point_expression" class="text" maxlength="255" title="${message("admin.promotion.pointExpressionTitle")}" />
				</td>
			</tr>
			<tr>
				<th>

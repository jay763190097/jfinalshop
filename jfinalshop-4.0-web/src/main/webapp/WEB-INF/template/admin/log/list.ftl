...
<title>${message("admin.log.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.log.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "operation"] class="current"[/#if] val="operation">${message("Log.operation")}</li>
					<li[#if pageable.searchProperty == "operator"] class="current"[/#if] val="operator">${message("Log.operator")}</li>
				</ul>
			</div>
		</div>

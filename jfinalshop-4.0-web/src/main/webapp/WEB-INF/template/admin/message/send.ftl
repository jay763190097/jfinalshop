	...
	<form id="inputForm" action="sendSubmit.jhtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="draftMessage.username" class="text" value="${(draftMessage.receiver.username)!}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="draftMessage.title" class="text" value="${(draftMessage.title)!}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<textarea name="draftMessage.content" class="text">${(draftMessage.content)!}</textarea>
				</td>
			</tr>
			<tr>
				<th>

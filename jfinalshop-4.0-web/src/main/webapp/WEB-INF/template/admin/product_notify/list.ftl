...
<title>${message("admin.productNotify.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.productNotify.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "email"] class="current"[/#if] val="email">${message("ProductNotify.email")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="member_id">${message("ProductNotify.member")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="email">${message("ProductNotify.email")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="create_date">${message("admin.productNotify.createDate")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="modify_date">${message("admin.productNotify.notifyDate")}</a>
				</th>
				<th>
					<span>${message("admin.productNotify.status")}</span>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="has_sent">${message("admin.productNotify.hasSent")}</a>
				</th>
			</tr>

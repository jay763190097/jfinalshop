	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="shippingMethod.first_weight" class="text" maxlength="9" title="${message("admin.shippingMethod.weightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="shippingMethod.continue_weight" class="text" maxlength="9" title="${message("admin.shippingMethod.weightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="shippingMethod.default_first_price" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="shippingMethod.default_continue_price" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>

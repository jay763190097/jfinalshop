...
$().ready(function() {
	...
	$inputForm.validate({
		rules: {
            ...
            "productCategory.channel": "required"
		}
	});
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("ProductCategory.channel")}:
                </th>
                <td>
                    <input type="text" id="name" name="productCategory.channel" class="text" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>

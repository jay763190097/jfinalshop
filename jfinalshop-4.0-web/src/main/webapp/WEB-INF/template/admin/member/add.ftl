	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input tabContent">
			<tr>
				...
				<td>
					<input type="text" name="member.username" class="text" maxlength="${setting.usernameMaxLength}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="password" id="password" name="member.password" class="text" maxlength="${setting.passwordMaxLength}" autocomplete="off" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="member.nickname" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>

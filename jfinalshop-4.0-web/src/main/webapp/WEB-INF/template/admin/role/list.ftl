...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.role.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="is_enabled">${message("Role.isEnabled")}</a>
				</th>
				<th>
			...
			[#list page.list as role]
				<tr>
					...
					<td>
						<span class="${role.isEnabled?string("true", "false")}Icon">&nbsp;</span>
					</td>
					<td>

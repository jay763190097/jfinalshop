...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("Goods.channel")}:
                </th>
                <td>
                    <input type="text" name="goods.channel" class="text" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>
			...
			[#list goods.productImagesConverter as productImage]
				<tr>
					<td>
						...
						<a href="${base}${productImage.large}" target="_blank">${message("admin.common.view")}</a>
					</td>
					<td>

...
<title>${message("admin.deliveryTemplate.edit")} - Powered By JFinalShop</title>
...
$().ready(function() {
	...
	$inputForm.validate({
		rules: {
			...
			"deliveryTemplate.offsetx": {
				required: true,
				integer: true
			},
			"deliveryTemplate.offsety": {
				required: true,
				integer: true
			}
		},
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<input type="hidden" name="deliveryTemplate.id" value="${deliveryTemplate.id}" />
		<input type="hidden" id="content" name="deliveryTemplate.content" />
		<table class="input">
			<tr>
				<th>
				...
				<td>
					<input type="text" name="deliveryTemplate.name" class="text" value="${deliveryTemplate.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="background" name="deliveryTemplate.background" class="text" value="${deliveryTemplate.background}" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" id="width" name="deliveryTemplate.width" class="text" value="${deliveryTemplate.width}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="height" name="deliveryTemplate.height" class="text" value="${deliveryTemplate.height}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="deliveryTemplate.offsetx" class="text" value="${deliveryTemplate.offsetx}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="deliveryTemplate.offsety" class="text" value="${deliveryTemplate.offsety}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="deliveryTemplate.memo" class="text" value="${deliveryTemplate.memo}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>

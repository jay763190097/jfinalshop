...
<title>${message("admin.deliveryTemplate.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="deliveryTemplate.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="background" name="deliveryTemplate.background" class="text" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" id="width" name="deliveryTemplate.width" class="text" value="1000" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="height" name="deliveryTemplate.height" class="text" value="400" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="deliveryTemplate.offsetx" class="text" value="0" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="deliveryTemplate.offsety" class="text" value="0" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="deliveryTemplate.memo" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>

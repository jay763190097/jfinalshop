...
[@seo type = "brandList"]
	<title>[#if seo.title??][@seo.title?interpret /][#else]${message("shop.brand.title")}[/#if][#if showPowered] - Powered By JFinalShop[/#if]</title>
	...
	<div class="container brandList">
		<div class="row">
			...
			<div class="span10">
				...
				[@pagination pageNumber = page.pageNumber totalPages = page.totalPage pattern = "{pageNumber}.jhtml"]

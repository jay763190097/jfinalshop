...
<title>${message("shop.member.message.list")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
...
<body>
	...
	<div class="container member">
		<div class="row">
			...
			<div class="span10">
				<div class="list">
					<div class="title">${message("shop.member.message.list")} <span>(${message("shop.member.message.total", page.totalRow)})</span></div>

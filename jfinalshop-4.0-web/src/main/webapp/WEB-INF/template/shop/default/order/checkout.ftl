				...
				<div class="span12">
								...
								<label for="paymentMethod_${paymentMethod.id}">
									...
									<span>
										[#if paymentMethod.icon?has_content]
											<em style="border-right: none; background: url(${base}${paymentMethod.icon}) center no-repeat;">&nbsp;</em>
										[/#if]
					...
					<table class="product">
						...
						[#list order.orderItems as orderItem]
							<tr>
								<td>
									<img src="${base}${orderItem.product.thumbnail!setting.defaultThumbnailProductImage}" alt="${orderItem.product.name}" />
								</td>
								<td>

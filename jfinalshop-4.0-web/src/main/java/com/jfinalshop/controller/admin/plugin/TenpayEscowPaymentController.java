 ...
 * 
 */
@ControllerBind(controllerKey = "/admin/payment_plugin/tenpay_escow_payment")
public class TenpayEscowPaymentController extends BaseController {

	private TenpayEscowPaymentPlugin tenpayEscowPaymentPlugin = new TenpayEscowPaymentPlugin();
	...
	public void setting() {
		...
		render("/admin/plugin/tenpayEscowPayment/setting.ftl");
	}

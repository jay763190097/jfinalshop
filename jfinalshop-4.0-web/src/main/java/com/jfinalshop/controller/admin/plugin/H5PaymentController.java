 ...
 * 
 */
@ControllerBind(controllerKey = "/admin/payment_plugin/h5_payment")
public class H5PaymentController extends BaseController {

	private H5PaymentPlugin h5PaymentPlugin = new H5PaymentPlugin();
	 ...
	 */
	public void install() {
		if (!h5PaymentPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(h5PaymentPlugin.getId());
	...
	public void uninstall() {
		if (h5PaymentPlugin.getIsInstalled()) {
			pluginConfigService.deleteByPluginId(h5PaymentPlugin.getId());
		}
		renderJson(SUCCESS_MESSAGE);
	}
	 ...
	 */
	public void setting() {
		PluginConfig pluginConfig = h5PaymentPlugin.getPluginConfig();

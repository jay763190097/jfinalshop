 ...
 * 
 */
@ControllerBind(controllerKey = "/admin/payment_plugin/net_payment")
public class NetPaymentController extends BaseController {

	private NetPaymentPlugin netPaymentPlugin = new NetPaymentPlugin();
	 ...
	 */
	public void install() {
		if (!netPaymentPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(netPaymentPlugin.getId());
	...
	public void uninstall() {
		if (netPaymentPlugin.getIsInstalled()) {
			pluginConfigService.deleteByPluginId(netPaymentPlugin.getId());
		}
		renderJson(SUCCESS_MESSAGE);
	}
	 ...
	 */
	public void setting() {
		PluginConfig pluginConfig = netPaymentPlugin.getPluginConfig();

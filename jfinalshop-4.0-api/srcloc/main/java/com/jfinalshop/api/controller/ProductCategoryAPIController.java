...
public class ProductCategoryAPIController extends BaseAPIController {
	...
	public void findGrade() {
		...
		List<ProductCategory> productCategorys = productCategoryService.findGrade(grade, true, null);
	...
	public void findChildren() {
		...
		List<ProductCategory> productCategorys = productCategoryService.findChildren(productCategory, false, count);
	...
	public void findGoods() {
		...
		Page<Goods> goods = goodsService.findPage(type, productCategory, brand, promotion, tag, null, null, null, true, true, null, null, null, null, orderType, pageable);

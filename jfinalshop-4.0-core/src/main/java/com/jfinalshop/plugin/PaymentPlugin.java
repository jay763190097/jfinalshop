...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	...
	public abstract JSONObject getParameterMaps(String sn, String description, HttpServletRequest request) throws Exception;
	public abstract String getResult(String sn, String description, HttpServletRequest request) throws Exception;
	/**
	 * 验证通知是否合法
	 * 
	 * @param notifyMethod
	 ...
	 * @return 通知是否合法
	 */
	public abstract boolean verifyNotify(PaymentPlugin.NotifyMethod notifyMethod, HttpServletRequest request) throws Exception;

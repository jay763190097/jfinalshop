...
public class BaseService<M extends Model<M>> {
	...
	public List<M> findAll() {
		return findList(null, null, null);
	}
	/**
	 * 查找实体对象集合
	 * 
	 ...
	 * @return 实体对象集合
	 */
	public List<M> findList(Integer count, List<Filter> filters, List<Order> orders,String channel) {
		return findList(null, count, filters, orders,channel);
	}
	...
	public List<M> findList(Integer first, Integer count, List<Filter> filters, List<Order> orders ,String channel) {
		return baseDao.findList(first, count, filters, orders,channel);
	}

...
public class NavigationService extends BaseService<Navigation> {
	 ...
	 * @return 导航
	 */
	public List<Navigation> findList(Integer count, List<Filter> filters, List<Order> orders, boolean useCache,String channel) {
		return navigationDao.findList(null, count, filters, orders,channel);
	}

...
public class GoodsListDirective extends BaseDirective {
	...
	private GoodsService goodsService = appContext.getInstance(GoodsService.class);
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<Goods> goodsList = goodsService.findList(type, productCategoryId, brandId, promotionId, tagId, attributeValueMap, startPrice, endPrice,null, true, true, null, null, null, hasPromotion, orderType, count, filters, orders, useCache);
